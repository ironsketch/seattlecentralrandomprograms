 ...
 */
public class LiftMeHigherFilter implements Filter {
				...
				for (int row3x3 = 0; row3x3 < 3; row3x3++){
					for (int col3x3 = 0; col3x3 < 3; col3x3++){
						if (row3x3 != 1 && col3x3 != 1){
							addRED += data[row - 1 + row3x3][col - 1 + col3x3].red;
							
							addBLUE += data[row - 1 + row3x3][col - 1 + col3x3].blue;

							addGREEN += data[row - 1 + row3x3][col - 1 + col3x3].green;
						}
					}
				}
