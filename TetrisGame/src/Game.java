...
public class Game {
	...
	// array of shapes to call randomly
	...
	public void movePiece(Direction direction) {
		if (piece != null && direction == direction.STRAIGHTDOWN) {
			while (piece.canMove(Direction.DOWN)){
	    		piece.move(Direction.DOWN);
	    		}
		} else if(piece != null && direction == direction.ROTATE){
			if (piece.canRotate()){
				piece.rotate();
			}
		}
	...
	private Piece createPiece(){
		Piece[] shapes = {new BarShape(1, Grid.WIDTH / 2 - 1, grid),
				new LShape(1, Grid.WIDTH / 2 - 1, grid),
				new JShape(1, Grid.WIDTH / 2 - 1, grid),
				new ZShape(1, Grid.WIDTH / 2 - 1, grid),
				new TShape(1, Grid.WIDTH / 2 - 1, grid),
				new SquareShape(1, Grid.WIDTH / 2 - 1, grid),
				new SShape(1, Grid.WIDTH / 2 - 1, grid)};
		//return random piece
		//int randShape = 0;
		int randShape = rand.nextInt(7);
		
		//return new SquareShape(1, Grid.WIDTH / 2 , grid); //square
